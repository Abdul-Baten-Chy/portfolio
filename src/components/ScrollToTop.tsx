import useDebounce from "@/hook/useDevounce";
  ...
  return (
    pathname !== "/write-blog" && (
      <motion.button
        ...
        initial={{ scale: 0 }}
        animate={{
          scale: scrollPosition > pageHeight - scrollPosition - 100 ? 1 : 0, // if user has scrolled too much, show the button
        }}
...
// it would be in  separeate file as an hook
